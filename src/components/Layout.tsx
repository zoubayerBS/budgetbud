...
const Layout: React.FC = () => {
    return (
        <div className="min-h-screen bg-white dark:bg-black font-sans text-slate-800 dark:text-slate-100 transition-all duration-300 flex flex-col relative overflow-hidden">
            {/* Background Decorative Wave / Glow - Hidden in light mode for pure white */}
            <div className="hidden dark:block fixed -top-32 -left-32 w-[900px] h-[700px] pointer-events-none opacity-[0.08] dark:opacity-[0.12] z-0 blur-[120px] rotate-12">
