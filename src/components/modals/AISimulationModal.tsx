...
const AISimulationModal: React.FC<AISimulationModalProps> = ({ isOpen, onClose, baseIncome, baseExpense }) => {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 md:p-8">
            ...
            <div className="relative w-full max-w-2xl max-h-[90vh] bg-white dark:bg-black rounded-[3.5rem] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.3)] border border-white/10 dark:border-slate-800/50 overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-10 duration-700 flex flex-col noise-texture custom-scrollbar overflow-y-auto">
                ...
                <div className="p-10 md:p-14 relative z-10 flex flex-col">
                    ...
                    <div className="flex items-center justify-between mb-12">
                        ...
                        <button
                            onClick={onClose}
                            className="w-14 h-14 flex items-center justify-center rounded-[1.5rem] bg-white dark:bg-white/5/50 text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all shadow-inner border border-transparent hover:border-slate-200 dark:hover:border-slate-700"
                        >
                            <X className="w-6 h-6" />
                        </button>
                    </div>
                    ...
                    <div className="space-y-10">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-16 pr-8 py-6 bg-white dark:bg-white/5/20 border border-slate-100 dark:border-slate-800/50 rounded-[2rem] outline-none font-bold text-lg text-slate-900 dark:text-white"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-3">
                                    ...
                                    <input
                                        ...
                                        placeholder="0.00"
                                        className="w-full px-8 py-6 bg-white dark:bg-white/5/20 border border-slate-100 dark:border-slate-800/50 rounded-[2rem] outline-none font-black text-2xl text-slate-900 dark:text-white tracking-tighter"
                                    />
                                </div>
                                <div className="space-y-3">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-8 py-6 bg-lime-500/5 border border-lime-500/20 rounded-[2rem] outline-none font-black text-2xl text-lime-600 dark:text-lime-400 tracking-tighter"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        {mathResult ? (
                            <div className="space-y-8 animate-in slide-in-from-top-4 duration-500">
                                <div className="p-10 bg-slate-900 text-white rounded-[3rem] relative overflow-hidden group border border-white/5">
                                    ...
                                    <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                                        <div className="space-y-4 text-center md:text-left">
                                            <p className="text-[10px] font-black text-lime-400 uppercase tracking-[0.3em]">Date d'Accomplissement</p>
                                            ...
                                            <div className="flex items-center gap-3 justify-center md:justify-start">
                                                ...
                                                <span className="text-lime-200/50 font-bold">Dans environ {mathResult.monthsNeeded} mois</span>
                                            </div>
                                        </div>
                                ...
                                <div className="p-8 bg-lime-500/[0.03] dark:bg-lime-500/[0.05] rounded-[2.5rem] border border-lime-500/10 flex items-center gap-6 group hover:bg-lime-500/[0.08] transition-all">
                                    <div className="w-14 h-14 rounded-2xl bg-lime-500/10 flex items-center justify-center text-lime-500 shrink-0 group-hover:rotate-12 transition-transform">
                                        <BrainCircuit className="w-7 h-7" />
                                    </div>
                                    <div className="space-y-1">
                                        <p className="text-[9px] font-black text-lime-400 uppercase tracking-widest">Stratégie AI Tactique</p>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="p-6 bg-lime-500/5 rounded-3xl border border-lime-500/10 flex items-start gap-4">
                                        <TrendingUp className="w-5 h-5 text-lime-500 mt-1 shrink-0" />
                                        <div className="space-y-1">
                                    ...
                                    <div className="p-6 bg-lime-500/5 rounded-3xl border border-lime-500/10 flex items-start gap-4">
                                        <Target className="w-5 h-5 text-lime-500 mt-1 shrink-0" />
                                        <div className="space-y-1">
